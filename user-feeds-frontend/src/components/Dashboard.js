...
export default class Sidebar extends Component {
 ...
 //Require map search to redux
  ...
  currentComponent = () => {
    ...
    if (this.state.home) return <p> Home Component </p>;
    else if (this.state.bookmarks) return <p>Bookmark Component</p>;
    ...
    else if (this.state.bookmarks) return <p>Bookmarks Component</p> ;
