...
import {
  followingCount,
  followerCount
} from "../redux/actions/followerfollowing-actions";
...
class Profile extends Component {
  ...
  async componentDidMount() {
    ...
    if (id !== localStorage.getItem("cookie1")) {
      ...
      console.log(
        "IN PROFILE this.props.isfollowingvalue",
        this.props.isfollowingvalue
      );
  ...
  onValidate = e => {
    ...
    console.log(
      "the zipcode is ",
      this.state.zipcode,
      validZipcode.test(this.state.zipcode)
    );
    if (this.state.zipcode && !validZipcode.test(this.state.zipcode)) {
      this.setState({
        IncorrectCredentials:
          "Invalid Zipcode. Valid Zipcodes should be like 90086-1929 or 90086"
      });
      return false;
    }
                ...
                <div className="jumbotron345">
                  ...
                  <div className="jumbo2">
                    <div className="para34">
                      <div className="in">
                        <p className="para2">
                          {this.state.userdetails.profilename}
                        </p>

                        <button onClick={this.profileedit} className="para6">
                          Edit Profile
                        </button>

                        <div className="followtoggle para234">
                          {" "}
                          {this.state.followDisplay && (
                            <button onClick={this.onFollow}>Follow</button>
                          )}
                        </div>
                      </div>
                      <p className="para3">
                        {this.state.userdetails.userhandle}
                      </p>
                      <br />
                      <div className="in">
                        <span className="parafirstlastname2">
                          <b>First Name</b> {this.state.userdetails.firstname}{" "}
                        </span>
                        <span className="parafirstlastname6">
                          <b>Last Name</b> {this.state.userdetails.lastname}
                        </span>
                      </div>
                      <br />
                      <div className="in">
                        <span className="parafirstlastname2">
                          <b>Born </b> {this.state.dateofbirth}
                        </span>
                        <span className="parafirstlastname6">
                          <b>Joined </b> {this.state.created_at}
                        </span>
                      </div>
                      <br />

                      <div className="in">
                        <p className="increasefont">
                          <Link to="/followers">
                            {this.state.Followers} Followers
                          </Link>
                        </p>
                        <p className="increasefont parafirstlastname6">
                          <Link to="/followers">
                      ...
                      <span className="parafirstlastname2">
                        {" "}
                        <b>City</b> {this.state.userdetails.city}
                      </span>
                      <span className="parafirstlastname4">
                        <b>State</b> {this.state.userdetails.state}{" "}
                      </span>
                      <span className="parafirstlastname5">
                        <b>Zipcode</b> {this.state.userdetails.zipcode}{" "}
                      </span>
                    </div>
                  </div>
                  <div>
                    ...
                    >
                      ...
                      <Modal.Body>
                        ...
                        <input
                          ...
                          type="text"
                        ></input>
                        <div className="field1234567" style={{ color: "red" }}>
