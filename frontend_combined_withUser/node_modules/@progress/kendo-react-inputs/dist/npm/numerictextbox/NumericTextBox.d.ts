...
export declare class NumericTextBox extends React.Component<NumericTextBoxProps, NumericTextBoxState> implements FormComponent {
    /**
     * @hidden
     */
    static propTypes: {
        ...
        format: PropTypes.Requireable<string | PropTypes.InferProps<{
            ...
            useGrouping: PropTypes.Requireable<boolean>;
     ...
     * @hidden
     */
    static getDerivedStateFromProps(props: NumericTextBoxProps, state: NumericTextBoxState): {
        value: number;
    };
    /**
     * @hidden
