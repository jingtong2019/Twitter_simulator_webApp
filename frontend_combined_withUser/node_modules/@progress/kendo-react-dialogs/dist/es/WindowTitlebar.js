...
var WindowTitleBarComponent = function (_a) {
    ...
    return (React.createElement("div", { className: "k-window-titlebar k-dialog-titlebar k-header", style: { touchAction: 'none' }, ref: forwardedRef, onDoubleClick: onDoubleClick },
